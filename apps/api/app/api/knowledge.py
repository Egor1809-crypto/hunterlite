...
# ---------------------------------------------------------------------------
# RAG knowledge base browser — full transparency for users
# 2026-05-04: user requested "видеть всё что AI знает" — every chunk,
# every Q-template, every common error, every blitz answer should be
# browsable + copyable from /pvp.
# ---------------------------------------------------------------------------
...
async def browse_knowledge_base(
    ...
    """Return RAG chunks for transparency view on /pvp.
