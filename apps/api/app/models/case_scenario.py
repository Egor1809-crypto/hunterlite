...
class CaseScenario(Base):
    ...
    stage1: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
    stage2: Mapped[dict] = mapped_column(JSONB, nullable=False, default=dict)
...
class CaseAttempt(Base):
    ...
    stage1_answers: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    stage2_order: Mapped[list] = mapped_column(JSONB, nullable=False, default=list)
    stage1_score: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    stage2_score: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
