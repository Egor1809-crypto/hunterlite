...
const CHAMPIONSHIP_KNOWLEDGE =
  [
    ...
    "— Условия участия: сдать аттестацию (все экзамены ≥ 88%, именной сертификат); активная платная подписка, открывающая доступ к курсам «Юридические аспекты» и «Экспертный уровень БФЛ»; оставленный отзыв о платформе.",
