...
export default function LoginPage() {
  ...
  // 2026-06-19 (149-ФЗ): Google removed. Only Yandex ID remains as OAuth.
  const [oauthStatus, setOauthStatus] = useState<{ yandex: boolean }>({ yandex: false });

  useEffect(() => {
    api.get<{ yandex: boolean }>("/auth/oauth/status")
      .then(setOauthStatus)
  ...
  return (
    ...
    >
      ...
      >
        {/* Editorial header — one accent mark, eyebrow code, confident title */}
        <div className="mb-9">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          {/* Social login — Yandex ID only (149-ФЗ; Google removed 2026-06-19) */}
          {oauthStatus.yandex && (
            <div className="relative">
