      ...
      >
        ...
        <div className="px-7 py-8 sm:px-10 sm:py-10">
          ...
          <ul className="mt-4 space-y-2.5">
            {[
              "Данные используются для вашего обучения и оценки результатов.",
              "Для работы AI-функций привлекаются обработчики (подробнее — в Политике обработки ПДн); в маркетинге данные используются только при отдельном согласии.",
