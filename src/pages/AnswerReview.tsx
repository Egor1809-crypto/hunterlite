      ...
      <div className="grid lg:grid-cols-3 gap-4">
        ...
        <div className="lg:col-span-2 space-y-4">
          ...
          <Card className="p-5 shadow-card">
            <div className="text-[11px] uppercase tracking-wider font-semibold text-muted-foreground mb-2">Вопрос AI-клиента</div>
          ...
          <Card className="p-5 bg-ai-soft border-ai/20">
            <div className="flex gap-3">
              ...
              <div>
                <div className="font-semibold text-ai-soft-foreground">AI-рекомендация</div>
