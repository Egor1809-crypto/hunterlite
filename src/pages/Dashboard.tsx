  ...
  return (
    <div className="p-4 md:p-8 max-w-7xl mx-auto space-y-6 animate-fade-in">
        ...
        <div className="flex items-start gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground mt-1.5">
              Сегодня хороший день, чтобы потренировать сложный кейс. ИИ-клиент уже ждёт.
            </p>
          </div>
        </div>
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        {[
          { to: "/session/setup?mode=talk", icon: MessageSquare, title: "Поговорить с ИИ-клиентом", accent: "bg-accent text-accent-foreground" },
          ...
          <div className="grid sm:grid-cols-2 gap-4">
            ...
            <div className="bg-ai-soft rounded-xl p-4">
              <div className="flex items-center gap-2 mb-2">
                ...
                <span className="text-xs font-semibold uppercase tracking-wider text-ai-soft-foreground">ИИ-рекомендация</span>
              </div>
