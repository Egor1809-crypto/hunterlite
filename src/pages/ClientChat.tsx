...
const aiAnswers = [
  "Здравствуйте! Я NAVI-помощник по вопросам банкротства физических лиц. Опишите вашу ситуацию — какие долги и за какой период.",
      ...
      <div className="flex-1 flex flex-col max-w-3xl w-full mx-auto p-4 sm:p-6">
        <div className="mb-5">
          ...
          <p className="text-muted-foreground mt-2 text-sm">
            NAVI ответит на типовые вопросы. Для детального разбора оставьте заявку — с вами свяжется юрист.
          </p>
        </div>
        ...
        <Card className="p-3 mb-4 bg-warning-soft border-warning/30 flex gap-2.5">
          ...
          <div className="text-xs text-warning-soft-foreground">
            <span className="font-semibold">NAVI-помощник не заменяет консультацию юриста.</span>{" "}
