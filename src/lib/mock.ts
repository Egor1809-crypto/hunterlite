...
export const notifications = [
  ...
  { id: 2, type: "warning" as const, title: "Рекомендация AI", text: "Повторите блок про ипотечное жильё перед экзаменом.", time: "вчера" },
...
export const dialogScript = [
  { from: "ai", text: "Здравствуйте. Я слышал, что после банкротства у меня заберут вообще всё имущество. Это так?" },
  { from: "user", text: "Нет, не всё имущество подлежит реализации. Например, единственное жильё, если оно не в ипотеке, защищено законом. Но всё зависит от вашей конкретной ситуации." },
  { from: "ai", text: "А что с моей квартирой в ипотеке? Она же оформлена на меня." },
  { from: "user", text: "Если квартира в ипотеке, она считается залоговым имуществом банка и может быть включена в конкурсную массу. Это требует отдельного анализа документов." },
  { from: "ai", text: "А долги по ЖКХ и алиментам — их тоже спишут?" },
];
