...
export const accessRoutes = [
  ...
  { path: "/session/arena", allowedRoles: ["employee"] },
  ...
  { path: "/courses", allowedRoles: ["employee"] },
...
export const apiAccessPolicies = [
  ...
  { method: "POST", path: "/api/ai/chat", permission: "training:complete:self" },
  { method: "POST", path: "/api/ai/speech", permission: "training:complete:self" },
  { method: "POST", path: "/api/ai/transcriptions", permission: "training:complete:self" },
  { method: "POST", path: "/api/trainings/sessions", permission: "training:create:self" },
  { method: "GET", path: "/api/trainings/sessions/:id", permission: "training_result:read" },
